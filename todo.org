...
* TODO Benchmarks for the engine <2015-04-04 Sat>
Use this to test any pervasive changes to the rest of the framework related to performance
- [ ] Calculate the number of frames per second the engine can do
* TODO FIX debuggable collision circle overlay is not centered correctly
