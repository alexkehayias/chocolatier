...
* TODO Talk for LispNYC <2015-08-16 Sun>
DEADLINE: <2015-09-08 Tue>
- Topics
  - Profiling
  - Functional game engine design
  - Performance optimization of ClojureScript
  - Embedded repl as a game mechanic
* TODO Add static fn analysis and pseudo name optimization for min build <2015-08-01 Sat>
...
* TODO Systems should only be running one component function instead of a collection <2015-08-02 Sun>

* TODO Refactor events <2015-08-02 Sun>
- Too slow
...
- [ ] Reduce the usage of events
  ...
  - [ ] Use state machines instead of requiring a message to be present
    Example: Only send an event if something has changed instead of requiring a message every frame
    - [ ] Update controllable/react-to-input to only emit an event if the state has changed
    - [ ] Update moveable to only emit when movement has changed


* TODO Systems can run on more than one Component state
* TODO demo and deck for LispNYC september
- Embedded repl?
