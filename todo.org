...
* TODO z-index for sprites
- [ ] Draw tiles first
- [ ] Save z-index to component state
- Use display containers https://github.com/pixijs/pixi.js/issues/300
* TODO Fix figwheel reloading not working for example.action_rpg
